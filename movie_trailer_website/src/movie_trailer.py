...
dangal = media.Movie("Dangal",
                        "Former wrestler trains his daughters to follow in his footsteps",
                        "https://upload.wikimedia.org/wikipedia/en/9/99/Dangal_Poster.jpg",
                        "https://www.youtube.com/watch?v=x_7YlGv9u1g")

bahubali2 = media.Movie("Baahubali2: The Conclusion",
...
titanic = media.Movie("Titanic",
                        "Epic movie on the ill-fated maiden voyage of the Titanic ship",
                        "https://upload.wikimedia.org/wikipedia/en/2/22/Titanic_poster.jpg",
                        "https://www.youtube.com/watch?v=2e-eXJ6HgkQ")

avatar = media.Movie("Avataar",
...
#pass the movie list to the trailer website method that renders the movies to UI
